...
namespace Bicep.Core.TypeSystem.Az
{
    public class AzResourceTypeProvider : IResourceTypeProvider
    {
        ...
        private ResourceType GenerateResourceType(ResourceScope targetScope, ResourceTypeReference typeReference, bool isExistingResource)
        {
        ...
        private ResourceType SetBicepResourceProperties(ResourceType resourceType, Azure.Bicep.Types.Concrete.ScopeType resourceScope, bool isExistingResource)
        {
        ...
        public ResourceType GetType(ResourceScope targetScope, ResourceTypeReference typeReference)
        {
            ...
            {
                resourceType = GenerateResourceType(targetScope, typeReference, false);
        ...
        public ResourceType GetExistingType(ResourceScope targetScope, ResourceTypeReference typeReference)
        {
            // It's important to cache this result because LoadResourceType is an expensive operation
            if (!loadedExistingTypeCache.TryGetValue(typeReference, out var resourceType))
            {
                resourceType = GenerateResourceType(targetScope, typeReference, true);
                loadedExistingTypeCache[typeReference] = resourceType;
            }
